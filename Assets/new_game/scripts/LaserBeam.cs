...
public class LaserBeam
{
    ...
    void CheckHit(RaycastHit hitInfo, Vector3 direction, LineRenderer laser)
    {
        ...
        //LOL//////////////
        else if (hitInfo.collider.gameObject.tag == "Refract1")
        {
            Vector3 pos = hitInfo.point;
            laserIndices.Add(pos);
            ...
            float n1 = refractiveMaterials["Air"];
            float n2 = refractiveMaterials["Diamond"];
            ...
            Ray ray1 = new Ray(newPos1, refractedVector);
            Vector3 newRayStartPos = ray1.GetPoint(2.4f); //показатель преломления в сеткле 1.5
        ...
        //LOL///////////
        else if (hitInfo.collider.gameObject.tag == "Refract2")
        {
            Vector3 pos = hitInfo.point;
            laserIndices.Add(pos);
            ...
            float n1 = refractiveMaterials["Air"];
            float n2 = refractiveMaterials["Kron"];
            ...
            Ray ray1 = new Ray(newPos1, refractedVector);
            Vector3 newRayStartPos = ray1.GetPoint(1.7f); //показатель преломления в сеткле 1.5
...
public class LaserBeam
{
    ...
    void CheckHit(RaycastHit hitInfo, Vector3 direction, LineRenderer laser)
    {
        ...
        else if (hitInfo.collider.gameObject.tag == "Refract")
        {
            ...
            float n1 = refractiveMaterials["Air"];
            var refraction = hitInfo.collider.gameObject.GetComponent<Refraction>();
            if (refraction)
            {
                float n2 = refraction.n2;
